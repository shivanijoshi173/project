...
public class TC_04CreateOprWithNegotiationReviewPOM 
{
	@Test(groups = "regression")
	public void CreateOprWithNegotiationReview() throws Throwable
	{
	   ...
	   String opnm=elib.getExcelData("Sheet1", 4, 1);
	   copr.oppnm(opnm);
	   
	   copr.getOgrIcon();
	   String amt=elib.getExcelData("Sheet1", 4, 4);
	   copr.Amount(amt);
	   String optyp=elib.getExcelData("Sheet1", 4, 5);
	   copr.opptype(optyp);
