...
public class TC_02CreateOprWithPerceptionAnalysisPOM 
{
	@Test(groups = "smoke")
	public void CreateOprWithPerceptionAnalysis() throws Throwable
	{
	   ...
	   String opnm=elib.getExcelData("Sheet1", 6, 1);
	   copr.oppnm(opnm);
	   
	   copr.getOgrIcon();
	   String amt=elib.getExcelData("Sheet1", 6, 4);
	   copr.Amount(amt);
	   String optyp=elib.getExcelData("Sheet1", 6, 5);
	   copr.opptype(optyp);
