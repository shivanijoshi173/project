...
public class TC_05CreateOprWithClosedWonPOM 
{
	@Test(groups = "regression")
	public void CreateOprWithClosedWon() throws Throwable
	{
	   ...
	   String opnm=elib.getExcelData("Sheet1", 5, 1);
	   copr.oppnm(opnm);
	   
	   copr.getOgrIcon();
	   String amt=elib.getExcelData("Sheet1", 5, 4);
	   copr.Amount(amt);
	   String optyp=elib.getExcelData("Sheet1", 5, 5);
	   copr.opptype(optyp);
