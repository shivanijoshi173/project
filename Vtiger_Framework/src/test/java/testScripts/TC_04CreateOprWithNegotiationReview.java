...
public class TC_04CreateOprWithNegotiationReview 
{
	static 
	{
	...
	@Test
	public static void CreateOprWithProposalPriceQuote() throws Throwable
	{
	...
	String oprName=eu.getExcelData("Sheet1", 4, 1);
	...
	driver.findElement(By.xpath("//a[text()='dell']")).click();
	...
	webd.SelectOption(S4,"Negotiation/Review");
	...
	//Description
	String Des=eu.getExcelData("Sheet1", 4, 13);
	...
	String expResult="Negotiation/Review";
	 String actResult = driver.findElement(By.xpath("//font[text()='Negotiation/Review']")).getText();
