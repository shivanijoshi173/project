...
public class TC_02CreateOprWithPerceptionAnalysis 
{
	static 
	{
	...
	@Test
	public static void CreateOprWithPerceptionAnalysis() throws Throwable
	{
	...
	String oprName=eu.getExcelData("Sheet1", 2, 1);
	...
	webd.SelectOption(S4,"Perception Analysis");
	...
	//Description
	String Des=eu.getExcelData("Sheet1", 2, 13);
	...
	String expResult="Perception Analysis";
	 String actResult = driver.findElement(By.xpath("//font[text()='Perception Analysis']")).getText();
