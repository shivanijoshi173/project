...
public class TC_03CreateOprWithProposalPriceQuote 
{
	static 
	{
	...
	String oprName=eu.getExcelData("Sheet1", 3, 1);
	...
	webd.SelectOption(S4,"Proposal/Price Quote");
	...
	//Description
	String Des=eu.getExcelData("Sheet1", 3, 13);
	...
	String expResult="Proposal/Price Quote";
	 String actResult = driver.findElement(By.xpath("//font[text()='Proposal/Price Quote']")).getText();
