...
public class TC_05CreateOprWithClosedWon 
{
	static 
	{
	...
	String oprName=eu.getExcelData("Sheet1", 5, 1);
	...
	*/
	...
	while(it.hasNext())
	{
		...
		if(!parent.equals(winId))
		{
			...
			driver.findElement(By.linkText("IBM")).click();
		}
	}	
	driver.switchTo().window(parent);
	...
	webd.SelectOption(S4,"Closed Won");
	...
	//Description
	String Des=eu.getExcelData("Sheet1", 5, 13);
	...
	String expResult="Closed Won";
	 String actResult = driver.findElement(By.xpath("//font[text()='Closed Won']")).getText();
